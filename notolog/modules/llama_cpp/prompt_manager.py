...
- Functionality: Manages prompt formatting and maintains a history of prompts.
...
class PromptManager(QObject):
    ...
    def __init__(self, system_prompt=None, max_history_size=None, parent=None):
        ...
        with self._lock:
            ...
            self.logger = logging.getLogger('llama_cpp_prompt_manager')
    ...
    def limit_history_size(self):
        ...
        if self.max_history_size:  # Ensure max_history_size is set before enforcing limits
