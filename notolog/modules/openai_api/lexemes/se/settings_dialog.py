...
lexemes = {
    ...
    "module_openai_api_key_input_accessible_description": "OpenAI API-nyckel",
    "module_openai_api_supported_models_label": "Stödda modeller",
    "module_openai_api_model_names_combo_placeholder_text": "Välj modell",
    "module_openai_api_model_names_combo_accessible_description": "Välj bland stödda modeller",
