...
lexemes = {
    ...
    "module_openai_api_url_input_accessible_description": "OpenAI API URL",
    "module_openai_api_key_input_placeholder_text": "API key",
    "module_openai_api_key_input_accessible_description": "OpenAI API key",
    "module_openai_api_supported_models_label": "Supported models",
    "module_openai_api_model_names_combo_placeholder_text": "Choose model",
    "module_openai_api_model_names_combo_accessible_description": "Supported models to choose",
    ...
    "module_openai_api_base_response_temperature_input_accessible_description":
        "Adjusts model output randomness. Higher values increase creativity; lower values enhance determinism.",
