...
lexemes = {
    ...
    "dialog_encrypt_delete_source_title": "Ta bort okrypterad källfil",
    "dialog_encrypt_delete_source_text": "Den krypterade filen skapades. Ta bort den okrypterade källfilen \"{file_name}\"?",
