# Spanish lexemes ai_assistant.py
lexemes = {
    # Asistente IA
    ...
    "dialog_hardware_cpu_tooltip": "Inferencia en CPU",
    "dialog_hardware_gpu_tooltip": "Aceleración GPU",
    ...
    "dialog_prompt_history_file_header": "# Asistente IA [{datetime}]",
