...
lexemes = {
    ...
    "tree_filter_input_placeholder_text": "Filtro rápido",
    "tree_filter_input_accessible_desc": "Filtrar archivos y directorios por nombre",
    "tree_filter_clear_button_tooltip": "Limpiar filtro",
    "tree_filter_clear_button_accessible_name": "Limpiar campo de filtro",
    ...
    "dialog_encrypt_delete_source_title": "Eliminar archivo de origen sin cifrar",
    "dialog_encrypt_delete_source_text": "El archivo cifrado se creó correctamente. ¿Eliminar el archivo de origen sin cifrar \"{file_name}\"?",
    ...
    "message_app_config_file_access": "Permiso denegado al acceder al archivo de configuración de la aplicación en "
