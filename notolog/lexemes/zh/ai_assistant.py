# Chinese lexemes ai_assistant.py
lexemes = {
    # AI 助手
    "dialog_title": "向 AI 提问",
    "dialog_prompt_input_placeholder_text": "请求",
    "dialog_prompt_input_accessible_description": "输入请求以提供给 AI 助手上下文",
    "dialog_response_output_placeholder_text": "响应数据",
