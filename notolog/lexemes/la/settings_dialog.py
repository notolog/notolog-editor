...
lexemes = {
    ...
    "general_app_default_path_label": "Index praedefinitus pro notis",
    "general_app_default_path_input_accessible_description": "Praedefine indicem ubi notae reponentur",
    "general_app_default_path_input_placeholder_text": "Eligere vel indicem inscribere",
    "general_app_elements_visibility_label": "Administrare visibilitatem elementorum",
