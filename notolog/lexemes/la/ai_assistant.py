# Lexica Communia Latine ai_assistant.py
lexemes = {
    # Assistens AI
    "dialog_title": "Postulatio ad AI",
    "dialog_prompt_input_placeholder_text": "Postulatio",
    "dialog_prompt_input_accessible_description": "Postulationem ingredi ad contextum assistenti AI praebendum",
    "dialog_response_output_placeholder_text": "Responsi data",
