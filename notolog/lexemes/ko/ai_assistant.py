# Korean lexemes ai_assistant.py
lexemes = {
    # AI 보조
    "dialog_title": "AI에게 요청",
    "dialog_prompt_input_placeholder_text": "요청",
    "dialog_prompt_input_accessible_description": "AI 보조에게 컨텍스트를 제공하기 위한 요청 입력",
    "dialog_response_output_placeholder_text": "응답 데이터",
