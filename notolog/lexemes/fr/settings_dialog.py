...
lexemes = {
    ...
    "general_app_default_path_label": "Dossier par défaut pour les notes",
    "general_app_default_path_input_accessible_description": "Spécifiez le dossier par défaut où les notes seront stockées",
    "general_app_default_path_input_placeholder_text": "Sélectionnez ou entrez un chemin de dossier",
    "general_app_elements_visibility_label": "Gérer la visibilité des éléments",
